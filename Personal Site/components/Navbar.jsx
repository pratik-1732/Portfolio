  ...
  return (
    <div className="fixed w-full flex justify-end items-center gap-10 px-10 py-7 bg-transparent">
      <ul className="flex justify-end items-center gap-5">
        <li className="cursor-pointer text-lg font-semibold text-gray-200 hover:cursor-pointer hover:text-[#7f6ce0] duration-500 transition-colors hover:underline underline-offset-4">
          Home
        </li>
        <li className="cursor-pointer text-lg font-semibold text-gray-200 hover:cursor-pointer hover:text-[#7f6ce0] duration-500 transition-colors hover:underline underline-offset-4">
          About
